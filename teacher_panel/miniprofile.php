     ...
     class="profile-img">
                        ...
                        <div class="col-md-8 profile-right">
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-text">
                                    <small>Gender</small>
                                    <span><?php echo $row['gender'] ?? 'Not Set'; ?></span>
                                </div>
                            </div>
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-text">
                                    ...
                                    <span><?php echo $row['ph_no'] ?? 'Not Available'; ?></span>
                                </div>
                            </div>
                            ...
                            <div class="info-box">
                                ...
                                <div class="info-text">
                                    <small>Address</small>
                                    <span><?php echo $row['address'] ?? 'Not Available'; ?></span>
                                </div>
                            </div>
