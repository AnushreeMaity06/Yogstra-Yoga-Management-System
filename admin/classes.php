...
// Total data count
$total_result = $conn->query("SELECT COUNT(id) AS total FROM classes");
...
$result = $conn->query("SELECT * FROM classes LIMIT $start, $limit");
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <ul style="list-style-type:none;padding-left:0px;">
                        <?php foreach ($benefits as $benefit) { ?>
                          <li ><i class="fa-regular fa-circle-check" style="color:#ba6a4a;"></i><?php echo trim($benefit); ?></li>
                        <?php } ?>
                      </ul> -->
                    </td>
                    ...
                    <td>
                       <!-- Edit Button -->
                      <a href="view_classdetails.php?id=<?php echo $row['id']; ?>"
                        class="view-btn">
