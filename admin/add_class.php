...
/* Teacher list */
$teacher_query = mysqli_query($conn, "SELECT * FROM users WHERE role='teacher'");
// echo mysqli_num_rows($teacher_query);
...
if (isset($_POST['submit'])) {
    ...
    $conn->query("INSERT INTO classes (name, instructor, level, duration, price,schedule_date,start_time,end_time,description,benefits, status)
    VALUES ('$name', '$instructor', '$level', '$duration', '$price','$schedule_date','$start_time','$end_time', '$description','$benefits','Active')");
...
<body>
    ...
    <!-- Class Name -->
    <div class="col-md-6 mb-3">
        <label class="form-label">Class Benefits</label>
        <textarea 
               name="benefits"
               class="custom-input"
               required>
    ...
    <script type="text/javascript">
        ...
        function updateDuration() {
            ...
            if (start && end) {
                ...
                let startMinutes = parseInt(sh) * 60 + parseInt(sm);
